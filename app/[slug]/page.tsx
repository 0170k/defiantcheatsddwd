...
const blogData: Record<string, {
  ...
  "defiant-cs2-cheat": {
    title: "Defiant CS2 Cheat", subtitle: "Dominate Counter-Strike 2 with Premium External Tools", game: "Counter-Strike 2", image: "/cs2-card.png",
    sections: [
      { title: "About Our CS2 Cheat", content: "Our CS2 Predator cheat is the ultimate tool for Counter-Strike 2 players looking to gain a competitive edge. Built with a focus on legit cheating and staying undetected, this fully external cheat offers a comprehensive suite of features including aimbot, triggerbot, ESP, chams, and more. Perfect for both casual play and competitive matches." },
      { title: "Advanced Aimbot & Triggerbot", content: "Our aimbot features customizable FOV, smooth aiming, auto-wall capabilities, and intelligent target selection. The triggerbot complements this with hitchance settings and smoke/flash ignore options. Both systems include recoil control to keep your shots accurate while maintaining a natural appearance." },
      { title: "Comprehensive Visuals", content: "See everything with our detailed ESP system featuring player boxes, health bars, armor indicators, skeleton rendering, and chams with material selection. The glow feature highlights enemies through walls, while off-screen arrows keep you aware of threats outside your view. Customize every element to your preference." },
      { title: "Unique Features", content: "CS2 Predator includes exclusive features like night mode, grenade trajectory prediction, C4 timer, and damage indicators. The built-in skin changer lets you use any skin, and the external radar provides tactical awareness. Status tags show when enemies are flashed, scoped, or planting." },
      { title: "Undetected & External", content: "As a fully external cheat, CS2 Predator operates outside the game process, making detection significantly harder. We continuously update our bypass methods to stay ahead of VAC and other anti-cheat measures. Our track record speaks for itself with consistent uptime and satisfied customers." },
    ],
  },
  "defiant-apex-cheat": {
    title: "Defiant Apex Legends Cheat", subtitle: "Become the Champion with Premium Enhancements", game: "Apex Legends", image: "/apex-card.png",
    sections: [
      { title: "About Our Apex Cheat", content: "Apex Legends demands fast reflexes and perfect aim. Our Ultimate Apex cheat provides everything you need to dominate the Outlands. From precise aimbot with prediction to comprehensive ESP and radar, this tool transforms your gameplay while maintaining a low profile against anti-cheat systems." },
      { title: "Precision Aimbot", content: "Our aimbot features mouse and memory aim options with adjustable smoothing for natural-looking movements. The prediction system accounts for bullet travel time and drop, ensuring your shots connect even at long range. Target lock keeps your crosshair on enemies during fast-paced fights." },
      { title: "Complete Player ESP", content: "Know exactly where every squad is with our detailed ESP. See player names, box outlines, skeleton rendering, squad information, distance, health, and shield status. Customize visible and invisible colors to quickly identify threats through cover. The radar provides an additional layer of tactical awareness." },
      { title: "World ESP & Loot Detection", content: "Find the best loot quickly with our World ESP that highlights loot, death boxes, supply drops, zip lines, and respawn beacons. No more wasting time searching buildings - head straight to the gear you need. Filter items by rarity to focus on what matters." },
      { title: "Battle Mode & Safety", content: "Toggle Battle Mode for combat situations to optimize performance when it counts. Off-screen enemy arrows keep you aware of threats from all directions. Our config system lets you save and share settings, while regular updates ensure continued compatibility with game patches." },
    ],
  },
}
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  if (!blog) return { title: "Page Not Found", description: "The requested page could not be found." }
  return {
    title: blog.title,
    description: blog.subtitle + ". " + blog.sections[0]?.content.slice(0, 150) + "...",
    openGraph: { title: blog.title + " | Defiant Cheats", description: blog.subtitle, images: [blog.image], type: "article" },
    twitter: { card: "summary_large_image", title: blog.title + " | Defiant Cheats", description: blog.subtitle, images: [blog.image] },
  }
}
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative">
      ...
      <main className="relative z-10 max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mb-8 rounded-2xl overflow-hidden border border-border/40 bg-card/60">
          {blog.isLogo ? (
        ...
        <div className="space-y-5">
          {blog.sections.map((section, index) => (
            <div key={index} className="p-6 rounded-2xl bg-card/60 border border-border/40 hover:border-primary/15 transition-all backdrop-blur-sm">
        ...
        <div className="mt-12 p-8 rounded-2xl bg-primary/5 border border-primary/15 text-center">
          ...
          <Link href="/#products-list" className="inline-flex items-center gap-2 px-6 py-3 text-sm font-medium rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-all shadow-lg shadow-primary/20">
